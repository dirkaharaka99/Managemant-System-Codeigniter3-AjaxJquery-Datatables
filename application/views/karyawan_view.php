							...
							<div class="modal-body">
								...
								<form id="addRecordForm">
									...
									<div class="input-group mb-3">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" id="nama" placeholder="Nama karyawan" aria-label="Nama karyawan" aria-describedby="basic-addon1">
                                        </div>
									...
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text bg-info text-white" id="basic-addon1"><i class="fas fa-globe"></i></span>
										</div>
                                        <div class="col">
									...
									<div class="input-group mb-3">
                                        ...
                                        <div class="col">
										    <input type="text" class="form-control" id="no_hp" placeholder="Nomor Hp karyawan">
                                        </div>
									</div>
									...
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text bg-info text-white" id="basic-addon1"><i class="fas fa-address-book"></i></span>
										</div>
                                        <div class="col">
									...
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text bg-info text-white" id="basic-addon1"><i class="fas fa-laptop"></i></span>
										</div>
										<div class="col">
                                            <select id="jabatan" class="custom-select">
										...
										<div class="col-md-12">
											...
											<form id="editForm">
												...
												<div class="input-group mb-3">
                                                    ...
                                                    <div class="col">
													    <input type="text" class="form-control" id="edit_nama" placeholder="Edit Nama karyawan">
                                                    </div>
                                                 </div>
											...
											<!-- Jenis Kelamin -->
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="col">
                                                        <label for="Tanggal Lahir">Tanggal Lahir:</label>
                                                        <input type="date" id="edit_tgl_lahir" name="edit_tgl_lahir">
                                                    </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="col">
                                                        <input type="text" class="form-control" id="edit_alamat" placeholder="Alamat karyawan">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="col">
                                                        <select id="edit_jabatan" class="custom-select">
                                                                <option >----- pilih jabatan -------</option>
                                                                <option value="Kasir">Kasir</option>
                                                                <option value="Pelayan">Pelayan</option>
                                                                <option value="Helper">Helper</option>
...
$(document).on("click", "#add", function(e) {
    ...
    if (nama == "" || jenis_kelamin == "" || no_hp == "" ) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url(); ?>index.php/karyawan/insert",
            data: fd,
            processData: false,
            contentType: false,
            dataType: "json",
...
function fetch() {
    $.ajax({
        type: "get",
        url: "<?php echo base_url(); ?>index.php/karyawan/fetch",
        dataType: "json",
        success: function(response) {
            var i = "1";
...
$(document).on("click", "#edit", function(e) {
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>index.php/karyawan/edit",
        type: "get",
        dataType: "JSON",
        data: {
            edit_id: edit_id,
        ...
        success: function(data) {
            // console.log(data.post.jenis_kelamin);
            ...
            if (data.res === "success") {
                ...
                $("#edit_tgl_lahir").val(data.post.tgl_lahir);
                $("#edit_no_hp").val(data.post.no_hp);
                $("#edit_alamat").val(data.post.alamat);
                $(`#jabatan`).find(`option[value="${data.jabatan}"]`).prop('selected',true);
                $("#edit_jabatan").val(data.post.jabatan );
            } else {
...
$(document).on("click", "#update", function(e) {
    ...
    var edit_jabatan =  $("#edit_jabatan option:selected").text();
    ...
    if (edit_nama == "" || edit_jenis_kelamin == "" || edit_no_hp == ""  ) {
        ...
        fd.append("tgl_lahir", edit_tgl_lahir);
        fd.append("no_hp", edit_no_hp);
        fd.append("alamat", edit_alamat);
        fd.append("jabatan", edit_jabatan);
        
        $.ajax({
            type: "post",
            url: "<?php echo base_url(); ?>index.php/karyawan/update",
            data: fd,
            processData: false,
            contentType: false,
            dataType: "json",
